...
<head>
    ...
    <style>
        ...
        #viewcalen .modal-dialog{
            width: 50%;
            height: 50%;
            padding:0;
            margin:0;
        }
        #viewcalen .modal-content{
            width: 50%;
            height: 50%;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <ol class="breadcrumb breadcrumb-arrow">
                        <li class="active"><span>Student's Subject</span></li>
                    </ol>
                    ...
                    ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn-editsubjectstudent btn btn-primary btn-sm" data-toggle="modal" data-sids='<?php echo $row['sched_id']; ?>' data-day='<?php echo $row['day']; ?>' data-tin='<?php echo $row['time_in']; ?>' data-tout='<?php echo $row['time_out']; ?>' data-target="#editsubjectstudent"> <span class="fa fa-fw fa-edit" aria-hidden="true"></span>
                                            </button> <a data-confirm="Are you sure you want to delete?" href="../php/deletestudsubject.php?ssid=<?php echo $row['ss_id']; ?>" class="btn btn-danger btn-sm"><span class="fa fa-fw fa-trash-o" aria-hidden="true"></span></a> 
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><i class="glyphicon glyphicon-time"></i> Add Student's Subject</h4>
                                    </div>
                                    <form action="../php/addstudsubject.php" method="post">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control " id="ids" name="ssid">
                                                </div>  
                                                <select name="addstud" class="form-control input-lg" style="margin-bottom:10px;" required>
                                                    <option>Select Student</option>
                                                    <?php
                                                        $faculty = mysqli_query($connect,"SELECT * FROM tbl_Student");
                                                        while($row = mysqli_fetch_array($faculty,MYSQLI_ASSOC)){
                                                            echo "<option value=".$row['school_ID'].">".$row['lname'].", ".$row['fname']."</option>";
                                                        }
                                                    ?>
                                                </select>
                                                <select name="schede" class="form-control input-lg">
                                                    <option>Select Schedule</option>
                                                    <?php
                                                        $faculty = mysqli_query($connect,"SELECT * FROM tbl_class_schedule INNER JOIN tbl_faculty ON tbl_faculty.faculty_ID=tbl_class_schedule.faculty_ID LEFT JOIN tbl_subject ON tbl_subject.sub_id=tbl_class_schedule.sub_id RIGHT JOIN tbl_schedule ON tbl_schedule.sched_id=tbl_class_schedule.sched_id");
                                                        while($row = mysqli_fetch_array($faculty,MYSQLI_ASSOC)){
                                                            echo "<option value=".$row['c_sched_id'].">".$row['f_fname']." ".$row['f_lname']." - ".$row['subject_code']." - ".$row['day']." ".$row['time_in']."-".$row['time_out']."</option>";
                                                        }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="col-sm-12">
                                                  <div class="row">
                                                        <div class="col-md-12"> 
                                                                    ...
                                                                    <button type="button" data-toggle="modal" data-target="#addcalen" class="btn btn-primary pull-right sbtn-lg" style="margin-right:10px;">
                                                                <i class="glyphicon glyphicon-plus"></i>
                                                            </button>
                    ...
                    ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn-edit btn btn-primary btn-sm" data-toggle="modal" data-sids='<?php echo $row['sched_id']; ?>' data-day='<?php echo $row['day']; ?>' data-tin='<?php echo $row['time_in']; ?>' data-tout='<?php echo $row['time_out']; ?>' data-target="#edit"> <span class="fa fa-fw fa-edit" aria-hidden="true"></span>
                                            </button> <a data-confirm="Are you sure you want to delete?" href="../php/deletestudsubject.php?sids=<?php echo $row['sched_id']; ?>" class="btn btn-danger btn-sm"><span class="fa fa-fw fa-trash-o" aria-hidden="true"></span></a> 
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title"><i class="glyphicon glyphicon-time"></i> Add Schedule</h4>
                                    </div>
                                    <form action="../php/addsched.php" method="post">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <select name="faculty" class="form-control input-lg" style="margin-bottom:10px;" required>
                                                ...
                                                <select name="schedule" class="form-control input-lg">
                                                    <option>Select Schedule</option>
                                                    <?php
    ...
    <script>
        $(function(){        
            $(".btn-edit").click(function() {
                ...
                var sname = $(this).data("day");
                var tname = $(this).data("tin");
                var docum = $(this).data("tout");
        ...
        $(document).ready(function() {
            $('a[data-confirm]').click(function(ev) {
                ...
                if (!$('#dataConfirmModal').length) {
                    $('body').append('<div id="dataConfirmModal" class="modal fade" role="dialog" aria-labelledby="dataConfirmLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header modal-header-warning"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> <h4 class="modal-title" id="dataConfirmLabel">Delete Students Subject</h4></div><div class="modal-body"></div><div class="modal-footer"><a class="btn btn-danger" id="dataConfirmOK">Yes</a><a class="btn btn-danger" data-dismiss="modal">No</a></div></div></div></div>');
                } id="dataConfirmOK"
