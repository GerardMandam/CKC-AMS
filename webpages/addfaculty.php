...
<body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a data-toggle="collapse" data-target="#stud4"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Faculty <i class="fa fa-fw fa-caret-down" aria-hidden="true"></i></a>
                        <ul id="stud4" class="collapse">
                            <li>
    ...
    <div class="row">
     ...
     <ol class="breadcrumb breadcrumb-arrow">
		<li class="active"><span>Add Faculty</span></li>
	</ol>    
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group form-group-lg">
                    ...
                    <input id="form_name" type="text" name="idf" class="form-control" placeholder="Enter Faculty ID.... " required="required" data-error="School ID is required!">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group form-group-lg">
                    ...
                    <input id="Lastname" type="text" name="lnamef" class="form-control" placeholder="lastname..." required="required" data-error="lastname is required!">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group form-group-lg">
                    ...
                    <input id="Firstname" type="text" name="fnamef" class="form-control" placeholder="firstname..." required="required" >
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group form-group-lg">
                    ...
                    <input id="middlename" type="text" name="mnamef" class="form-control" placeholder="middle name..." required="required" >
                    <div class="help-block with-errors"></div>
                </div>
            </div>
