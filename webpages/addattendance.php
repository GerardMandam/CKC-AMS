                    ...
                    ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn-edit btn btn-primary btn-sm" data-toggle="modal" data-sids='<?php echo $row[' c_sched_id ']; ?>' data-faculty='<?php echo $row[' faculty_ID ']; ?>' data-subject='<?php echo $row[' sub_id ']; ?>' data-schedule='<?php echo $row[' sched_id ']; ?>' data-semester='<?php echo $row[' sem ']; ?>' data-target="#editsched"> <span class="fa fa-fw fa-edit" aria-hidden="true"></span>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../php/updatesched.php" method="post">
                                            ...
                                            <input type="text" class="form-control input-lg" id="faculupdate" name="faculty">

                                            <select name="faculty" id="faculupdate" class="form-control input-lg" style="margin-bottom:10px;" required>
                                                    <option>Select Faculty</option>
                                                    <?php
                                                        $faculty = mysqli_query($connect,"SELECT * FROM tbl_faculty");
                                                        while($row = mysqli_fetch_array($faculty,MYSQLI_ASSOC)){
                                            ...
                                            <select name="subject" id="subjupdate" class="form-control input-lg">
                                                <option>Select Subject</option>
                                                <?php
                                                    $faculty = mysqli_query($connect,"SELECT * FROM tbl_subject");
                                                    while($row = mysqli_fetch_array($faculty,MYSQLI_ASSOC)){
                                            ...
                                            <select name="schedule" id="schedupdate" class="form-control input-lg">
                                                    <option>Select Schedule</option>
                                                    <?php
                                                        $faculty = mysqli_query($connect,"SELECT * FROM tbl_schedule");
                                                        while($row = mysqli_fetch_array($faculty,MYSQLI_ASSOC)){
                                            ...
                                            <select name="semester" id="semupdate" class="form-control input-lg">
                                                    <option value="1">1st Semester</option>
                                                    <option value="2">2nd Semester</option>
                                                </select>
    ...
    <script>
        $(function() {
            $(".btn-editsched").click(function() {
                ...
                var scheupdate = $(this).data("sched");
                var semeupdate = $(this).data("semester");



                $("#ids").val(s_id);
                $("#faculupdate").val(fupdate);
                $("#subjupdate").val(subupdate);
                $("#schedupdate").val(scheupdate);
                $("#semupdate").val(semeupdate)
