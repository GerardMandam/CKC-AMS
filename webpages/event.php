...
<head>
    ...
    <title>CKC Attendance Monitoring System - Event</title>
             ...
             <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <ol class="breadcrumb breadcrumb-arrow">
                        <li class="active"><span>Event Attendance</span></li>
                    </ol>
...
//                        $result = mysqli_query($connect, "SELECT * FROM tbl_schedule") or die(mysql_error());
                        $result = mysqli_query($connect, "SELECT * FROM tbl_event_attendance INNER JOIN tbl_events ON tbl_events.event_id=tbl_event_attendance.eat_id LEFT JOIN tbl_student ON tbl_student.school_ID=tbl_event_attendance.school_ID") or die(mysql_error());
                    ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $row['event_date']." ".$row['time_in']." ".$row['time_out'];?>
                                            </td>                                          
                                            <td>
                                                <?php echo $row['status'];?>
                                            </td>                                                                             
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <select name="faculty" class="form-control input-lg" style="margin-bottom:10px;" required>
                                                    ...
                                                    <?php
                                                        $faculty = mysqli_query($connect,"SELECT * FROM tbl_events");
